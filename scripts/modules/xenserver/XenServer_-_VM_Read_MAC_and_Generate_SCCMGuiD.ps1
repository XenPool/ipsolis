# NAME: XenServer - VM Read MAC and Generate SCCMGuiD
# DESC: Reads the primary MAC address from a XenServer VM, stores it into asset_pool.metadata.mac_address, and derives an SCCM GUID from the VM UUID. Exports $global:MACAddress and $global:SCCMGuiD.
