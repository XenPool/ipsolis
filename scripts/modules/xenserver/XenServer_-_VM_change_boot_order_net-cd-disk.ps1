# NAME: XenServer - VM change boot order (net-cd-disk)
# DESC: Sets HVM boot order to Network (PXE) -> CD-ROM -> Hard Disk (ndc) on a XenServer/XCP-ng VM
# XenServer - VM change boot order (net-cd-disk)
# Changes the boot order of a HVM VM to: Hard Disk -> CD-ROM -> Network
# XCP-ng / XenServer equivalent of: VMWare - VM change boot order (net-cd-disk).ps1
#
...
Write-Log "=== Starting XenServer Boot Order Change Script (Net-CD-Disk) ===" 'INFO'
