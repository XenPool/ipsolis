# NAME: SQL - Read Recycle VMs from Asset Pool
# DESC: Queries the asset_pool table for all assets with status Reinstall and exports them as $global:RecycleVMs (array of objects with id, name, asset_type_id).
param(
    [int]$DaysInStatus = 1
)
