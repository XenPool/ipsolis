# NAME: SCCM - Import Device And Add Collections
# DESC: Imports a device into SCCM via AdminService (Kerberos/GSSAPI), polls for the ResourceID, and adds direct-membership rules for an OS collection plus any optional app collections. Triggers a collection refresh afterwards.
param(
