...
from app.routes import admin, admin_api_tokens, admin_approval_delegations, admin_auth, admin_certifications, admin_cost_report, admin_license, admin_maintenance, admin_modules, admin_runbooks, admin_seed_export, admin_self, admin_setup, admin_standalone_runbooks, admin_users, approvals_external, assets, auth, certifications_external, health, metrics as metrics_route, orders, portal, portal_certifications, portal_delegations, ui, webhook
