...
> **(a) Kostenfreie Nutzung:** Die kostenfreie Nutzung ohne Lizenzdatei ist beschränkt auf (i) die rein private Nutzung durch natürliche Personen außerhalb jeder gewerblichen, beruflichen, behördlichen oder sonstigen organisatorischen Tätigkeit, (ii) die zeitlich begrenzte Evaluierung für bis zu 30 Tage, (iii) die nicht-produktive Nutzung zu Forschungs- und Lehrzwecken an staatlich anerkannten Bildungs- und Forschungseinrichtungen sowie (iv) die produktive Nutzung mit bis zu **25 aktiven Nutzern** (das „Free-Tier") – auch in einem gewerblichen, behördlichen oder sonstigen organisatorischen Kontext. Ein „aktiver Nutzer" ist eine eindeutige natürliche Person, identifiziert über ihre E-Mail-Adresse, die zu einem gegebenen Zeitpunkt mindestens eine aktive Asset-Anforderung oder -Zuweisung in der Software innehat; Personen, deren Anforderungen und Zuweisungen sämtlich beendet sind (z. B. storniert, abgelaufen, entzogen, zurückgegeben), werden nicht gezählt. Diese Nutzung ist unentgeltlich. Rechtsgrundlage: Schenkungsvertrag (§ 516 BGB).

> **(b) Kommerzielle (kostenpflichtige) Nutzung:** Jede über lit. (a) hinausgehende Nutzung setzt eine gültige kostenpflichtige Lizenzdatei voraus. Kommerziell ist insbesondere jeder produktive oder betriebliche Einsatz der Software **mit mehr als 25 aktiven Nutzern** im Rahmen einer gewerblichen, freiberuflichen, behördlichen oder sonstigen organisatorischen Tätigkeit – unabhängig von einer Gewinnerzielungsabsicht. Das Free-Tier nach lit. (a)(iv) stellt für sich genommen keine kommerzielle Nutzung dar. Eine Nutzung mit mehr als 25 aktiven Nutzern umfasst ausdrücklich auch die Nutzung durch juristische Personen des öffentlichen Rechts (z. B. Städte, Gemeinden, Behörden, Körperschaften und Anstalten des öffentlichen Rechts) sowie durch steuerbegünstigte oder gemeinnützige Körperschaften. Die kommerzielle Lizenz wird in Volumenbändern nach Anzahl aktiver Nutzer angeboten. Rechtsgrundlage: Mietvertrag über Software (§§ 535 ff. BGB).

**2.3** Vertragsgegenstand der kommerziellen Lizenzierung ist die zeitweise Überlassung der lizenzierten Software zur kommerziellen Nutzung im dokumentierten Funktionsumfang, freigeschaltet durch eine kryptographisch signierte Lizenzdatei (nachfolgend „Lizenzdatei" oder „.lic-Datei"). Die Lizenzdatei definiert den Umfang der erworbenen Lizenz (Laufzeit, lizenzierte Nutzerzahl bzw. Volumenband – d. h. die höchstzulässige Anzahl aktiver Nutzer; ein Band „0" bedeutet unbegrenzt –, freigeschaltete Features).
...
**4.4** Ablauf der Lizenzdatei: Nach Ablauf einer zeitlich befristeten Lizenzdatei gewährt der Anbieter eine Kulanzfrist von 30 Tagen, in der die Software weiterhin im bisherigen Lizenzumfang (insbesondere mit der bisherigen Nutzerzahl) produktiv genutzt werden kann. Nach Ablauf dieser Frist wechselt die Software automatisch in den kostenfreien Modus (Free-Tier nach Ziff. 2.2 (a); produktive Nutzung mit bis zu 25 aktiven Nutzern). Der Kunde behält auch in diesem Modus Zugriff auf seine eigenen, in der Betriebsumgebung gespeicherten Daten und kann diese exportieren. Liegt die Nutzung über dem Free-Tier-Limit, wird lediglich das Anlegen von Zugängen für zusätzliche neue Nutzer verhindert (Ziff. 2.2); der bestehende Betrieb läuft weiter. Der Anbieter haftet nicht für Schäden oder Betriebsunterbrechungen, die durch den automatischen Wechsel in den kostenfreien Modus nach Lizenzablauf entstehen. Der Kunde ist verpflichtet, rechtzeitig vor Ablauf eine Verlängerung zu beauftragen.

## 5) Vertragsschluss (kommerzielle Lizenz)

**5.1** Angebote des Anbieters auf der Website oder in Angebotsdokumenten stellen unverbindliche Aufforderungen zur Angebotsabgabe dar.
...
**7.1** Es gelten die zum Zeitpunkt des Vertragsschlusses vereinbarten Preise. Sofern nicht abweichend vereinbart, verstehen sich alle Preise zzgl. der gesetzlich geltenden Umsatzsteuer.

**7.2** Bei Abonnementlizenzen ist die Lizenzgebühr jährlich im Voraus fällig, sofern nichts anderes vereinbart wurde.

**7.3** Zahlungen sind innerhalb von 14 Tagen nach Rechnungsstellung ohne Abzug fällig, sofern nichts anderes vereinbart wurde.

**7.4** Bei Zahlungsverzug gelten die gesetzlichen Verzugszinsen nach § 288 Abs. 2 BGB. Der Anbieter ist bei anhaltendem Zahlungsverzug von mehr als 30 Tagen berechtigt, die Ausstellung einer Verlängerungs- oder Ersatzlizenzdatei zu verweigern und den Vertrag nach Ziff. 13.3 außerordentlich zu kündigen.

**7.5** Die verfügbaren Zahlungsarten werden dem Kunden im Angebot mitgeteilt.
...
**8.2** Die Software selbst ist im öffentlichen GitHub-Repository unter https://github.com/XenPool/ipsolis verfügbar. Der Kunde installiert und betreibt die Software eigenverantwortlich anhand der bereitgestellten Installationsdokumentation.

**8.3** Die Bereitstellung gilt als erfolgt, sobald die Lizenzdatei per E-Mail beim Kunden eingegangen oder im ipsolis-web-Portal abrufbar ist.

**8.4** Bei Verlust der Lizenzdatei stellt der Anbieter auf Anfrage gegen Nachweis der Lizenzberechtigung eine Ersatzdatei aus.
...
**9.2** Der Kunde darf die Software für eigene betriebsinterne Zwecke anpassen. Modifizierte Versionen dürfen ohne ausdrückliche schriftliche Zustimmung des Anbieters weder öffentlich verbreitet noch kommerziell Dritten zugänglich gemacht werden.

**9.3** Weitergabe, Unterlizenzierung, Vermietung, Verpachtung oder sonstige Überlassung der Lizenzdatei oder der Software an Dritte ist ohne ausdrückliche schriftliche Zustimmung nicht gestattet.
...
**9.7** Verletzt der Kunde die Nutzungsrechte schwerwiegend, kann der Anbieter den Vertrag außerordentlich kündigen. Das Nutzungsrecht erlischt sofort; der Kunde deinstalliert alle Instanzen und löscht alle Lizenzdateien, was er dem Anbieter auf Verlangen schriftlich bestätigt.
...
- korrekt konfigurierter Reverse Proxy (z. B. Nginx) mit TLS,
- funktionsfähige Netzwerkverbindung zu den konfigurierten externen Systemen (AD, SMTP, vSphere, SCCM etc.).

Mängelansprüche entfallen, wenn der Mangel auf die Nichterfüllung dieser Voraussetzungen zurückzuführen ist.
...
Ohne diese Mitwirkung ist der Anbieter von der Pflicht zur unverzüglichen Mängelbeseitigung befreit.

**10.5** Updates: Eine automatische Update-Pflicht des Anbieters besteht im reinen B2B-Verhältnis ohne gesondertes Service-Level-Agreement nicht. Der Anbieter informiert über kritische Sicherheitsupdates; die Installation obliegt dem Kunden. Der Kunde ist verpflichtet, kritische Sicherheitsupdates zeitnah einzuspielen. Schäden durch unterlassene Updates fallen nicht in die Haftungssphäre des Anbieters.
...
**11.4** Die Verjährungsfrist für Mängelansprüche aus kommerzieller Lizenzierung beträgt ein Jahr ab Bereitstellung der Lizenzdatei, soweit keine zwingenden gesetzlichen Regelungen entgegenstehen.
...
**13.1** Abonnementlizenzen haben eine Mindestlaufzeit von zwölf Monaten, sofern nicht ausdrücklich anders vereinbart. Sie verlängern sich automatisch um jeweils ein weiteres Jahr, wenn nicht eine Partei spätestens 30 Tage vor Ablauf der jeweiligen Laufzeit in Textform kündigt.
