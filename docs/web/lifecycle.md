...
## HR Leaver Flow *(Enterprise)*

When a user leaves the organisation, ip·Solis automatically revokes all their active access. The leaver flow is triggered by one of two Enterprise-gated entry points:
